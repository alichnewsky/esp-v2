...
ENVOY_SHA1 = "4d42fcb2fab57e9f6510301d8935484e1927c93a"

ENVOY_SHA256 = "aed3d59c3616f6ff31647b207684135124b4e13eb0f87aaf3f2e8adfa4e4385a"

http_archive(
    name = "envoy",
    sha256 = ENVOY_SHA256,
    strip_prefix = "envoy-" + ENVOY_SHA1,
    url = "https://github.com/alichnewsky/envoy/archive/" + ENVOY_SHA1 + ".zip",
)
